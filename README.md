...
```
ansible-playbook containerized-wordpress.yml -i hosts --extra-vars "distribution=1 system_user=ubuntu domain=custom.domain2.com wp_version=latest wp_db_user: admin wp_db_psw: change-M3 db_root_psw: change-M3 wp_db_name=wpdb wp_db_tb_pre=wp_ wp_db_host=mysql"
```
